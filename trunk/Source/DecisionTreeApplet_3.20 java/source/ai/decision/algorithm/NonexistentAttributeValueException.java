...
/**
 * Thrown on any attempt to access a non-existent attribute value.
 *
 * <p>
 * <b>Change History:</b>
 *
 ...
 * -->
 */
public class NonexistentAttributeValueException
    extends Exception
{
  // Constructors

  public NonexistentAttributeValueException()
  {
    super();
  }

  public NonexistentAttributeValueException( String msg )
  {
    super( msg );
  }
}
