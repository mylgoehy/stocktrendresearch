...
/**
 * Thrown if a particular metadata file contains a syntax error, or
 * there is a problem parsing the file.
 *
 * <p>
 * <b>Change History:</b>
 *
 ...
 * -->
 */
public class InvalidMetaFileException
    extends Exception
{
  // Constructors
  ...
  public InvalidMetaFileException( String msg )
  {
    super( msg );
  }
}
